...
<p>In order to start, you have to choose a class in the left sidebar!</p>
	...
	<li><span>Obviosly you can be only be in one <span class="special-char">class</span> at the same time... :) </span></li>
	<li><span>Your <span class="special-char">class</span> is ($userclassGOESHERE)</span></li>
